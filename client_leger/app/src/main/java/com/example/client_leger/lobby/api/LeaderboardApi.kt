...
import com.example.client_leger.lobby.model.LeaderboardStatsResponse
...
interface LeaderboardApi {
    ...
    @POST("leaderboard/getStats")
    suspend fun getStatsLeaderboard(): Response<LeaderboardStatsResponse>
}